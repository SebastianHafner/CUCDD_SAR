...
def load_sentinel1_timeseries(dataset: str, aoi_id: str, include_masked_data: bool = False,
    ...
    n = len(dates)
    pred_ts = np.zeros((*yx_shape, dataset_helpers.get_n_bands(dataset), n + 2 * ts_extension), dtype=np.float32)
